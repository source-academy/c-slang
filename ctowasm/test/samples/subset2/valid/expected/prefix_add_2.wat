(module
	...
	(func $main
		...
		(i32.store (i32.sub (global.get $bp) (i32.const 4)) (i32.load (i32.store (i32.sub (global.get $bp) (i32.const 4)) (i32.add (i32.load (i32.sub (global.get $bp) (i32.const 4))) (i32.const 1))) (i32.sub (global.get $bp) (i32.const 4))))
	)
	(start $main)
)
