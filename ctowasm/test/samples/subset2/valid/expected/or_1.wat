(module
	...
	(func $main
		...
		(i32.store (i32.sub (global.get $bp) (i32.const 8)) (i32.or (i32.or (i32.ne (i32.const 0) (i32.load (i32.sub (global.get $bp) (i32.const 4)))) (i32.ne (i32.const 0) (i32.const 10))) (i32.ne (i32.const 0) (i32.const 12))))
